...
| `Source` | select | `HEY`, `Zoho`, `Creative West`, `Colossal`, `Hyperallergic`, or `Artwork Archive` |
...
Colossal, Hyperallergic, and Artwork Archive use this same adapter. The shared discovery-evidence policy holds ambiguous landing-page/grouped-program candidates for review before this adapter is invoked; it does not weaken URL/title matching or manual-body protection.
