...
Email bodies, Colossal/Hyperallergic RSS/HTML, Artwork Archive HTML, Creative West API fields, attachments, linked pages, sender/provider identities, and AI output are untrusted. Secrets are stored only as Cloudflare or GitHub Actions secrets. No secret is placed in D1, R2 metadata, logs, source code, or generated types.
