/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example` (hash: 6fd1af3dae963b366b0e73b20c0c94ab)
// Runtime types generated with workerd@1.20260910.1 2026-08-04 nodejs_compat
interface __BaseEnv_Env {
	...
	COLOSSAL_ENABLED: "true";
	HYPERALLERGIC_ENABLED: "true";
	ARTWORK_ARCHIVE_ENABLED: "true";
	...
	NEWSLETTER_SETTINGS: string;
	BATCH_WORKFLOW: Workflow<Parameters<import("./src/index").OpportunityBatchWorkflow['run']>[0]['payload']>;
	NEWSLETTER_WORKFLOW: Workflow<Parameters<import("./src/index").OpportunityNewsletterWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "TIMEZONE" | "BATCH_HOURS" | "AI_MODEL" | "AI_CONFIDENCE_THRESHOLD" | "DIGEST_TO_EMAIL" | "DIGEST_FROM_EMAIL" | "DIGEST_FROM_NAME" | "NOTION_ENABLED" | "NOTION_DATA_SOURCE_ID" | "ZOHO_ENABLED" | "CREATIVE_WEST_ENABLED" | "COLOSSAL_ENABLED" | "HYPERALLERGIC_ENABLED" | "ARTWORK_ARCHIVE_ENABLED" | "ZOHO_ACCOUNT_EMAIL" | "ZOHO_DATACENTER" | "ZOHO_FOLDERS" | "INITIAL_BACKFILL_DAYS" | "ATTACHMENT_MAX_BYTES" | "R2_RETENTION_HOURS" | "NEWSLETTER_ENABLED" | "NEWSLETTER_HOUR" | "NEWSLETTER_DAYS" | "ADMIN_TOKEN" | "NOTION_TOKEN" | "ZOHO_CLIENT_ID" | "ZOHO_CLIENT_SECRET" | "ZOHO_REFRESH_TOKEN" | "NEWSLETTER_SETTINGS">> {}
}
